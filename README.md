...
2. Copy the following to the page you have chosen:
  ...
  ```javascript
  // [[File:User:He7d3r/Tools/InterProjectLinks.js]] (workaround for [[bugzilla:33355]])
  mw.loader.load( '//meta.wikimedia.org/w/index.php?title=User:He7d3r/Tools/InterProjectLinks.js&action=raw&ctype=text/javascript' );
  ```
